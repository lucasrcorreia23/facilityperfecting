-- Corrige roteiros FIESC: garante textos de teste (não fallback RD no app).
  update public.roleplay_readiness rr
    set roteiro = $fiesc_fix_rp106$## RP 1.1 — RP_106 · Carlos Mendes (Secretário de Planejamento e Inovação)
...
$fiesc_fix_rp106$,
  ...
  update public.roleplay_readiness rr
    set roteiro = $fiesc_fix_rp107$## RP 1.2 — RP_107 · Ana Paula Silveira (Secretária de Administração e Finanças)
...
$fiesc_fix_rp107$,
  ...
  update public.roleplay_readiness rr
    set roteiro = $fiesc_fix_rp108$## RP 1.3 — RP_108 · Roberto Nunes (Prefeito)
...
$fiesc_fix_rp108$,
  ...
  update public.roleplay_readiness rr
    set roteiro = $fiesc_fix_rp125$## RP 2.1 — RP_125 · Laura Martins (jovem, Curso Técnico SENAI)
...
$fiesc_fix_rp125$,
  ...
  update public.roleplay_readiness rr
    set roteiro = $fiesc_fix_rp128$## RP 2.2 — RP_128 · Carlos Almeida (operário, Cursos Profissionais SENAI)
...
$fiesc_fix_rp128$,
  ...
  update public.roleplay_readiness rr
    set roteiro = $fiesc_fix_rp131$## RP 2.3 — RP_131 · Mariana Silva (mãe, SESI Odonto)
